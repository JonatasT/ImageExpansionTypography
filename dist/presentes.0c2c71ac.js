...
},{"ev-emitter":"node_modules/ev-emitter/ev-emitter.js"}],"js/presentes/utils.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.wrapLines = exports.preloadImages = exports.getScrollValues = exports.calcWinsize = exports.adjustedBoundingRect = void 0;
...
var getScrollValues = exports.getScrollValues = function getScrollValues() {
...
var wrapLines = exports.wrapLines = function wrapLines(elems, wrapType, wrapClass) {
...
var adjustedBoundingRect = exports.adjustedBoundingRect = function adjustedBoundingRect(el) {
...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"js/presentes/textReveal.js":[function(require,module,exports) {
"use strict";
...
},{"gsap":"node_modules/gsap/index.js"}],"node_modules/split-type/dist/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/presentes/textLinesReveal.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var TextLinesReveal = exports.TextLinesReveal = /*#__PURE__*/function () {
...
},{"split-type":"node_modules/split-type/dist/index.js","./utils":"js/presentes/utils.js","gsap":"node_modules/gsap/index.js"}],"js/presentes/contentItem.js":[function(require,module,exports) {
"use strict";
 ...
 */
var ContentItem = exports.ContentItem = /*#__PURE__*/_createClass(
/**
 * Constructor.
...
function ContentItem(DOM_el) {
  ...
  // Text animations
  this.textReveal = new _textReveal.TextReveal(_toConsumableArray(this.DOM.el.querySelectorAll('.oh')));
...
},{"./textReveal":"js/presentes/textReveal.js","./textLinesReveal":"js/presentes/textLinesReveal.js"}],"js/presentes/imageCell.js":[function(require,module,exports) {
"use strict";
 ...
 */
var ImageCell = exports.ImageCell = /*#__PURE__*/_createClass(
/**
 * Constructor.
...
function ImageCell(DOM_el) {
  ...
  // The ContentItem instance
  this.contentItem = new _contentItem.ContentItem(document.querySelector("#".concat(this.contentId)));
});
},{"./contentItem":"js/presentes/contentItem.js"}],"js/presentes/grid.js":[function(require,module,exports) {
"use strict";
...
var Grid = exports.Grid = /*#__PURE__*/function () {
  ...
  function Grid(DOM_el) {
    ...
    _defineProperty(this, "textReveal", null);
    this.DOM.el = DOM_el;
    this.DOM.imageCells = _toConsumableArray(this.DOM.el.querySelectorAll('.grid__cell-img'));
    this.DOM.imageCells.forEach(function (el) {
      return _this.imageCellArr.push(new _imageCell.ImageCell(el));
    });
    ...
    this.DOM.miniGrid.cells = _toConsumableArray(this.DOM.miniGrid.el.querySelectorAll('.grid__cell'));
  ...
  return _createClass(Grid, [{
    ...
    value: function initEvents() {
      var _this2 = this;
      // for every imageCell
      var _iterator = _createForOfIteratorHelper(this.imageCellArr.entries()),
        _step;
      try {
        var _loop = function _loop() {
          var _step$value = _slicedToArray(_step.value, 2),
            position = _step$value[0],
            imageCell = _step$value[1];
          // Open the imageCell and reveal its content
          imageCell.DOM.el.addEventListener('click', function () {
            if (!_this2.isGridView || _this2.isAnimating) {
              return false;
            }
            _this2.isAnimating = true;
            _this2.isGridView = false;

            // Update the mini grid current cell
            if (_this2.currentCell !== -1) {
              _this2.DOM.miniGrid.cells[_this2.currentCell].classList.remove('grid__cell--current');
            }

            // Update currentCell
            _this2.currentCell = position;
            _this2.DOM.miniGrid.cells[_this2.currentCell].classList.add('grid__cell--current');
            _this2.showContent(imageCell);
          });
          ...
          imageCell.DOM.el.addEventListener('mouseenter', function () {
            ...
            _gsap.gsap.killTweensOf([imageCell.DOM.el, imageCell.DOM.inner]);
            _gsap.gsap.timeline({
              defaults: {
                duration: 2.4,
                ease: 'expo'
      ...
      this.DOM.backCtrl.addEventListener('click', function () {
        ...
        _this2.isAnimating = true;
        _this2.isGridView = true;
        _this2.closeContent();
      });
      this.DOM.miniGrid.cells.forEach(function (cell, position) {
        cell.addEventListener('click', function () {
          if (_this2.isAnimating || _this2.currentCell === position) {
            return false;
          }
          _this2.isAnimating = true;
          _this2.changeContent(position);
        });
      });
      ...
      window.addEventListener('resize', function () {
        ...
        var imageTransform = _this2.calcTransformImage();
        _gsap.gsap.set(_this2.imageCellArr[_this2.currentCell].DOM.el, {
    ...
    value: function showContent(imageCell) {
      ...
      _gsap.gsap.killTweensOf([imageCell.DOM.el, imageCell.DOM.inner, this.otherImageCells]);
      _gsap.gsap.timeline({
        defaults: {
          duration: 1.2,
          ease: 'expo.inOut'
        ...
        // overflow hidden
        onStart: function onStart() {
          return bodyEl.classList.add('oh');
        },
        ...
        y: imageTransform.y,
        onComplete: function onComplete() {
          return _gsap.gsap.set(imageCell.DOM.el, {
            willChange: ''
          });
        }
        ...
        scale: 1,
        onComplete: function onComplete() {
          return _gsap.gsap.set(imageCell.DOM.inner, {
            willChange: ''
          });
        }
        ...
        scale: 0.8,
        onComplete: function onComplete() {
          return _gsap.gsap.set(_this3.otherImageCells, {
            willChange: ''
          });
        },
        stagger: {
        ...
        _this3.DOM.content.classList.add('content--open');
    ...
    value: function closeContent() {
      ...
      _gsap.gsap.timeline({
        ...
        // overflow hidden
        onStart: function onStart() {
          return bodyEl.classList.remove('oh');
        },
        onComplete: function onComplete() {
        ...
        onComplete: function onComplete() {
          _gsap.gsap.set(_this4.DOM.miniGrid.el, {
            opacity: 0
          });
        }
      }, 'start').add(function () {
        ...
        _this4.DOM.content.classList.remove('content--open');
      }, 'start').add(function () {
        return imageCell.contentItem.DOM.el.classList.remove('content__item--current');
      }).addLabel('showGrid', 0).set([imageCell.DOM.el, this.otherImageCells], {
        willChange: 'transform, opacity'
        ...
        scale: 1,
        onComplete: function onComplete() {
          _gsap.gsap.set(_this4.otherImageCells, {
            willChange: ''
          });
          _gsap.gsap.set(_this4.DOM.el, {
            pointerEvents: 'auto'
          });
        },
        stagger: {
    ...
    value: function changeContent(position) {
      ...
      _gsap.gsap.timeline({
      ...
      }).addLabel('start', 0).add(imageCell.contentItem.textReveal.out(), 'start').add(imageCell.contentItem.textLinesReveal.out(), 'start').add(function () {
        ...
        opacity: 1,
        onComplete: function onComplete() {
          return _gsap.gsap.set(upcomingImageCell.DOM.el, {
            willChange: ''
          });
        }
    ...
    value: function calcTransformImage() {
      var cellrect = (0, _utils.adjustedBoundingRect)(this.imageCellArr[this.currentCell].DOM.el);
      return {
...
},{"./imageCell":"js/presentes/imageCell.js","./utils":"js/presentes/utils.js","./textReveal":"js/presentes/textReveal.js","gsap":"node_modules/gsap/index.js"}],"js/presentes/index.js":[function(require,module,exports) {
"use strict";
...
(0, _utils.preloadImages)('.grid__cell-img-inner, .slide-nav__img').then(function () {
  return document.body.classList.remove('loading');
});
},{"./utils":"js/presentes/utils.js","./grid":"js/presentes/grid.js"}],"../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/presentes/index.js"], null)
//# sourceMappingURL=/presentes.0c2c71ac.js.map