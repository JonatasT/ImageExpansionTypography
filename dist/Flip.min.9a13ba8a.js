...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/Flip.min.js":[function(require,module,exports) {
var define;
...
!function (t, e) {
  ...
  function A(t, e) {
    ...
    if (p.length || p.push(x(t, 1), x(t, 2), x(t, 3)), i = l ? f : c, l) u ? (a = -(r = z(t)).e / r.a, s = -r.f / r.d, n = d) : t.getBBox ? (r = t.getBBox(), a = (n = (n = t.transform ? t.transform.baseVal : {}).numberOfItems ? 1 < n.numberOfItems ? function _consolidate(t) {
      ...
      return e;
    }(n) : n.getItem(0).matrix : d).a * r.x + n.c * r.y, s = n.b * r.x + n.d * r.y) : (n = new M(), a = s = 0), e && "g" === t.tagName.toLowerCase() && (a = s = 0), (u ? l : h).appendChild(i), i.setAttribute("transform", "matrix(" + n.a + "," + n.b + "," + n.c + "," + n.d + "," + (n.e + a) + "," + (n.f + s) + ")");else {
  ...
  function ja(e, i, n) {
    var r,
      ...
      f = o.style,
      d = 4;
    if ("object" != _typeof(i) && (i = e), tt && 1 !== n) return tt._abs.push({
      t: o,
      b: e,
      a: e,
      sd: 0
    ...
    if (f.gridArea = "1 / 1 / 1 / 1", f.transition = "none", f.position = "absolute", f.width = l + "px", f.height = p + "px", f.top || (f.top = "0px"), f.left || (f.left = "0px"), h) r = new pt(o);else if ((r = _(e, D)).position = "absolute", e.simple) {
...
},{}]},{},["../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/Flip.min.js"], null)
//# sourceMappingURL=/Flip.min.9a13ba8a.js.map