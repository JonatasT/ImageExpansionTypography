...
},{"gsap":"node_modules/gsap/index.js","./utils":"js/utils.js"}],"js/effect-1/expandImageEffect.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ExpandImageEffect = void 0;
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var ExpandImageEffect = exports.ExpandImageEffect = /*#__PURE__*/function () {
  function ExpandImageEffect(el) {
    _classCallCheck(this, ExpandImageEffect);
  ...
  return _createClass(ExpandImageEffect, [{
    key: "initializeEffect",
    value: function initializeEffect(element) {
      // Scroll effect.
      this.scroll();
    }
    ...
    value: function scroll() {
      ...
      var flipstate = Flip.getState([this.image, this.expandTexts], {
        props: 'transform'
      });
...
},{}],"js/effect-2/expandImageEffect.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/effect-3/expandImageEffect.js":[function(require,module,exports) {
"use strict";
...
var ExpandImageEffect = exports.ExpandImageEffect = /*#__PURE__*/function () {
  ...
  return _createClass(ExpandImageEffect, [{
    ...
    value: function scroll() {
      // Temporarily add the final class to capture the final state
      this.wrapElement.classList.add('type--open');
      var flipstate = Flip.getState(this.image);
      // Remove the final class to revert to the initial state
      this.wrapElement.classList.remove('type--open');
...
},{"imagesloaded":"node_modules/imagesloaded/imagesloaded.js"}],"js/effect-4/expandImageEffect.js":[function(require,module,exports) {
"use strict";
...
var ExpandImageEffect = exports.ExpandImageEffect = /*#__PURE__*/function () {
  ...
  return _createClass(ExpandImageEffect, [{
    ...
    value: function scroll() {
      // Temporarily add the final class to capture the final state
      this.wrapElement.classList.add('type--open');
      var flipstate = Flip.getState([this.stack, this.image, this.expandTexts], {
        props: 'transform'
      });
      // Remove the final class to revert to the initial state
      this.wrapElement.classList.remove('type--open');
...
},{}],"js/effect-5/expandImageEffect.js":[function(require,module,exports) {
"use strict";
...
var _expandImageEffect = require("./effect-1/expandImageEffect.js");
var _expandImageEffect2 = require("./effect-2/expandImageEffect.js");
var _expandImageEffect3 = require("./effect-3/expandImageEffect.js");
var _expandImageEffect4 = require("./effect-4/expandImageEffect.js");
var _expandImageEffect5 = require("./effect-5/expandImageEffect.js");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _toConsumableArray(r) { return _arrayWithoutHoles(r) || _iterableToArray(r) || _unsupportedIterableToArray(r) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _iterableToArray(r) { if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r); }
function _arrayWithoutHoles(r) { if (Array.isArray(r)) return _arrayLikeToArray(r); }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; } // Importing utility function for preloading images
...
var init = function init() {
  ...
  var effects = [{
    ...
    effect: _expandImageEffect.ExpandImageEffect
  }, {
    selector: '[data-expand-2]',
    effect: _expandImageEffect2.ExpandImageEffect
  }, {
    selector: '[data-expand-3]',
    effect: _expandImageEffect3.ExpandImageEffect
  }, {
    selector: '[data-expand-4]',
    effect: _expandImageEffect4.ExpandImageEffect
  }, {
    selector: '[data-expand-5]',
    effect: _expandImageEffect5.ExpandImageEffect
  }];
...
(0, _utils.preloadImages)('.type__expand-img-inner').then(function () {
  document.body.classList.remove('loading');
  init();
});

// Preload images and fonts
Promise.all([(0, _utils.preloadImages)('.content--hero', '.content', '.content--left', 'content--right')]).then(function () {
  ...
  _toConsumableArray(document.querySelectorAll('a, .column__item-img, .type__expand-img-inner, .timer, image')).forEach(function (link) {
...
},{"./utils.js":"js/utils.js","./cursor":"js/cursor.js","./effect-1/expandImageEffect.js":"js/effect-1/expandImageEffect.js","./effect-2/expandImageEffect.js":"js/effect-2/expandImageEffect.js","./effect-3/expandImageEffect.js":"js/effect-3/expandImageEffect.js","./effect-4/expandImageEffect.js":"js/effect-4/expandImageEffect.js","./effect-5/expandImageEffect.js":"js/effect-5/expandImageEffect.js"}],"../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
